                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div className="rounded-lg border border-slate-700 bg-slate-950/40 p-3">
                                ...
                                <div className="text-[12px] text-slate-100 mt-2 space-y-1">
                                    <div><span className="text-slate-400">Romano:</span> {String((data.label as any).sequenceRomanFunctional ?? (data.label as any).sequenceRoman ?? data.label.romanDisplay ?? data.label.roman ?? '') || '—'}</div>
