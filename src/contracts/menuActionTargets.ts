...
export const MENU_ACTION_TARGET: Record<MenuAction, MenuActionTarget> = {
  ...
  [MENU_ACTIONS.SET_EXPORT_INCLUDE_TITLE]: 'grandStaff',
  [MENU_ACTIONS.SET_STAFF_SYSTEM_MODE]: 'grandStaff',
  [MENU_ACTIONS.SET_ORCHESTRAL_GROUPING]: 'grandStaff',
  [MENU_ACTIONS.SET_ROMAN_BASS_MODE]: 'grandStaff',
  [MENU_ACTIONS.SET_SEQUENCES_ENABLED]: 'grandStaff',
