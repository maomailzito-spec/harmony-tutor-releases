...
function createMenu() {
  ...
  const _menuStrings = {
    it: {
      ...
      reorderToolbar: 'Riordina toolbar (drag)…', transport: 'Barra comandi a toolbar nascosta (⌥T per nasconderla)',
    ...
    en: {
      ...
      reorderToolbar: 'Reorder toolbar (drag)…', transport: 'Command bar when the toolbar is hidden (⌥T to hide it)',
