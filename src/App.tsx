        ...
        try {
            (window as any).__htAiuto = () => {
                ...
                const righe = [
                    ...
                    { comando: '__htGeneratore()', stato: attivo('__htGeneratore'), cosa_dice: 'che cosa sta per usare il pannello del generatore: CHI sceglie l\'armonia (il riquadro dei gradi ha la precedenza su tutto), quali voci sono spuntate e quante note hanno. Il caso «ho cambiato qualcosa e il risultato non cambia»' },
                    { comando: '__htMelodia()', stato: attivo('__htMelodia'), cosa_dice: 'perche\' la spunta «armonizza la melodia esistente» e\' spenta: quante note vede il pannello, come sono distribuite fra le voci, quante sono diventate pause e quante stanno sulle tracce di accompagnamento' },
                    { comando: '__htRevoice()', stato: attivo('__htRevoice'), cosa_dice: 'il ciclo delle disposizioni sull\'accordo ACC selezionato: quante note distinte ha in mano, come le legge, e quali posizioni vengono scartate perche\' uguali a quella attuale' },
