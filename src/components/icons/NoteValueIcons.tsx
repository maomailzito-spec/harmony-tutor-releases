...
export const QuarterNoteIcon: React.FC = () => (
  <svg {...commonSvgProps}>
...
export const EighthNoteIcon: React.FC = () => (
  <svg {...commonSvgProps}>
    <ellipse cx="12" cy="24" rx="6" ry="4.5" fill="currentColor" transform="rotate(-20 12 24)" />
    <line x1="17.5" y1="22.5" x2="17.5" y2="4" stroke="currentColor" strokeWidth="2" />
...
export const SixteenthNoteIcon: React.FC = () => (
    <svg {...commonSvgProps}>
      <ellipse cx="12" cy="24" rx="6" ry="4.5" fill="currentColor" transform="rotate(-20 12 24)" />
      <line x1="17.5" y1="22.5" x2="17.5" y2="4" stroke="currentColor" strokeWidth="2" />
      <path d="M17.5 4 C 24 6, 24 10, 22 14" stroke="currentColor" strokeWidth="2.5" fill="none" />
...
export const ThirtySecondNoteIcon: React.FC = () => (
    <svg {...commonSvgProps}>
      <ellipse cx="12" cy="24" rx="6" ry="4.5" fill="currentColor" transform="rotate(-20 12 24)" />
      <line x1="17.5" y1="22.5" x2="17.5" y2="4" stroke="currentColor" strokeWidth="2" />
      <path d="M17.5 4 C 24 6, 24 10, 22 14" stroke="currentColor" strokeWidth="2.5" fill="none" />
...
export const SixtyFourthNoteIcon: React.FC = () => (
    <svg {...commonSvgProps}>
      <ellipse cx="12" cy="24" rx="6" ry="4.5" fill="currentColor" transform="rotate(-20 12 24)" />
      <line x1="17.5" y1="22.5" x2="17.5" y2="4" stroke="currentColor" strokeWidth="2" />
...
export const WholeRestIcon: React.FC = () => (
  <svg {...restSvgProps} fill="currentColor" stroke="none">
    <rect x="8" y="10" width="16" height="6" />
  </svg>
);

export const HalfRestIcon: React.FC = () => (
  <svg {...restSvgProps} fill="currentColor" stroke="none">
    <rect x="8" y="16" width="16" height="6" />
  </svg>
);

export const QuarterRestIcon: React.FC = () => (
  <svg {...restSvgProps}>
    <path d="M13 8 l3 4 l-4 4 l5 5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

export const EighthRestIcon: React.FC = () => (
  <svg {...restSvgProps} strokeWidth="2">
    <circle cx="18" cy="11" r="4" fill="currentColor" stroke="none" />
    <path d="M18 11 A 6 6 0 0 1 12 17 L 12 25" strokeLinecap="round" />
  </svg>
);

export const SixteenthRestIcon: React.FC = () => (
  <svg {...restSvgProps} strokeWidth="2">
...
export const ThirtySecondRestIcon: React.FC = () => (
  <svg {...restSvgProps} strokeWidth="2">
...
export const SixtyFourthRestIcon: React.FC = () => (
  <svg {...restSvgProps} strokeWidth="2">
...
// Triplet Icon
export const TripletIcon: React.FC = () => (
...
export const TieIcon: React.FC = () => (
    <svg className="h-8 w-8" viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="2.5">
